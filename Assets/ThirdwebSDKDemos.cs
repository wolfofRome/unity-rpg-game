...
public class ThirdwebSDKDemos : MonoBehaviour
{
    ...
    public async void OnBalanceClick()
    {
        ...
        balanceText.text =
            "Balance: " +
            balance.displayValue.Substring(0, 3) +
            " " +
            balance.symbol;
    }
    ...
    public async void OnSignClick()
    {
        ...
        {
            resultText.text =
                "Sig: " + data.payload.address.Substring(0, 6) + "...";
        }
        else
        {
    ...
    public async void GetERC721()
    {
        // fetch single NFT
        var contract =
            sdk.GetContract("0x2e01763fA0e15e07294D74B63cE4b526B321E389"); // NFT Drop
        count++;
    ...
    {
        var contract =
            sdk.GetContract("0x86B7df0dc0A790789D8fDE4C604EF8187FF8AD2A"); // Edition Drop
    ...
    {
        var contract =
            sdk.GetContract("0xB4870B21f80223696b68798a755478C86ce349bE"); // Token
    ...
    public async void MintERC721()
    {
        ...
        // sig mint
        var contract =
            sdk.GetContract("0x8bFD00BD1D3A2778BDA12AFddE5E65Cca95082DF"); // NFT Collection
        var meta =
            new NFTMetadata()
            {
                name = "Unity NFT",
    ...
    public async void GetListing()
    {
        ...
        var marketplace =
            sdk
                .GetContract("0xC7DBaD01B18403c041132C5e8c7e9a6542C4291A")
